...
public class Parkour : MonoBehaviour
{
    ...
    void Update()
    {
        if (enableVault && detectVaultObject.obstruction && !detectVaultObstruction.obstruction
            && !canVault && !isParkour && (Input.GetButtonDown("Jump")))
        {
            canVault = true;
        }
        ...
        if (enableClimb && detectClimbObject.obstruction && !detectClimbObstruction.obstruction
            && !canClimb && !isParkour && (Input.GetButtonDown("Jump")))
        {
            canClimb = true;
        }
